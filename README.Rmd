...
13. La última pregunta del formulario es sobre observaciones. Si tienes alguna que añadir, este es el momento. De lo contrario, presiona siguiente y guarda tu formulario. Puedes marcarlo como finalizado y enviarlo si lo deseas. También puede desmarcar la casilla de "Finalizado", si tienes previsto revisarlo más adelante. Presiona guardar y el formulario se cerrará. En el último radio, cierra el formulario y continúa al hexágono siguiente asignado.
...
-   Para identificación de especies: [Picture This](https://play.google.com/store/apps/details?id=cn.danatech.xingseus)
